...
<div class="col-md-6" style="padding: 5px;">
    ...
    <img src="{{ "/assets/topics/basic-css-zengarden-main.png" | prepend:site.baseurl }}"
        alt="A light green watercolor view of the CSS Zen Garden website.">  
    </a>
</div>
<div class="col-md-6" style="padding: 5px;">
<a href="http://www.csszengarden.com/216/">
<img src="{{ "/assets/topics/basic-css-zengarden-fk.png" | prepend:site.baseurl }}"
    alt="A light green watercolor view of the CSS Zen Garden website.">  
</a>
</div>
<div class="col-md-6" style="padding: 5px;">
<a href="http://www.csszengarden.com/221/">
<img src="{{ "/assets/topics/basic-css-zengarden-midcent.png" | prepend:site.baseurl }}"
    alt="A light green watercolor view of the CSS Zen Garden website.">  
</a>
</div>
<div class="col-md-6" style="padding: 5px;">
<a href="http://www.csszengarden.com/215/">
<img src="{{ "/assets/topics/basic-css-zengarden-robot.png" | prepend:site.baseurl }}"
    alt="A light green watercolor view of the CSS Zen Garden website.">  
</a>
</div>
</div>
...
#### Check in
Take some time to complete your reading and work on the hands on practice activities found in Chapter 4.  Answer the Review Questions at the end of the chapter, then move on to the last exercise where we will add some color to our first web site using CSS.
